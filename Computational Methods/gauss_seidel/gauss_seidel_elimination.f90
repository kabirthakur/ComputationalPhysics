PROGRAM gauss_siedel
	...
	integer :: m,choice,er,nswap,l,i,j,k=1,sum=0,flag=0,iter,max_iter=200
	real :: dummy,cas,temp
	...
	if(flag==n) then
		...
		write(*,*)"PRESS 1 to try and convert or press 2 for gauss elimination"
		read(*,*)choice
		if (choice==2)then
			do i=1,n
		do j=i+1,n
